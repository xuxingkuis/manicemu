...
public class ChromaColorPicker: UIControl, ChromaControlStylable {
    ...
    private(set) public weak var brightnessSlider: ChromaBrightnessSlider? {
        didSet {
            ...
            oldValue?.removeTarget(self, action: nil, for: .touchUpInside)
        }
    }
    ...
    private(set) public var currentHandle: ChromaColorHandle? {
        didSet {
            if let currentHandle {
                delegate?.colorPickerHandleDidChange(self, handle: currentHandle, to: currentHandle.color)
            }
        }
    }
    ...
    public func connect(_ slider: ChromaBrightnessSlider) {
        ...
        slider.addTarget(self, action: #selector(brightnessSliderDidValueChangeEnd(_:)), for: .touchUpInside)
    ...
    public override func endTracking(_ touch: UITouch?, with event: UIEvent?) {
        ...
        informDelegateOfColorChangeEnd()
    ...
    @objc
    internal func brightnessSliderDidValueChangeEnd(_ slider: ChromaBrightnessSlider) {
        delegate?.colorPickerHandleDidChangeEnd(self)
    }
    ...
    internal func informDelegateOfColorChangeEnd() { // TEMP:
        delegate?.colorPickerHandleDidChangeEnd(self)
    }
